...
class GoogleTests(unittest.TestCase):
    ...
    def testBlogsReturnsCorrectQuerystring(self):
        self.fake_blog_search_response()
        result_attributes = self.google.blogs('test', date = date(2009, 5, 31))
        expected_querystring = 'http://blogsearch.google.com/blogsearch_feeds?scoring=r&as_miny=2009&as_maxy=2009&as_maxd=31&num=1000&as_minm=5&as_q=test&output=atom&as_maxm=5&as_mind=25&as_drrb=b'
    ...
    def testNewsReturnsCorrectQuerystring(self):
        self.fake_news_search_response()
        result_attributes = self.google.news('test', date = date(2009, 5, 31))
        expected_querystring = 'http://news.google.com/news?scoring=r&as_miny=2009&as_maxy=2009&q=test&as_maxd=31&num=1000&as_minm=5&output=atom&as_maxm=5&as_mind=25&as_drrb=b'
