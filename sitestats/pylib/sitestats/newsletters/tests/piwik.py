...
class PiwikTests(unittest.TestCase):
    ...
    def testUniqueVisitors(self):
        self.fake_api_response(piwik, '{"max_actions":57,"nb_uniq_visitors":1796,"nb_visits":2011,"nb_actions":3755,"sum_visit_length":201371,"bounce_count":1511,"nb_visits_converted":0}')
    ...
    def testRaisesErrorWhenErrorReturned(self):
        self.fake_api_response(piwik, "{'message': 'You are requesting a precise subTable but there is not such data in the Archive.', 'result': 'error'}")
    ...
    def testSiteIds(self):
        self.fake_api_response(piwik, '[["1"],["2"],["3"]]')
        site_ids = self.piwik.site_ids()     
        self.assertEqual([1, 2, 3], site_ids, "sites returns the expected sites")

    def testSite(self):
        self.fake_api_response(piwik, '[{"idsite":"1","name":"PledgeBank","main_url":"http:\/\/www.pledgebank.com","ts_created":"2008-06-10 18:29:58","feedburnerName":"Piwik"}]')
    ...
    def testSites(self):
        self.fake_api_response(piwik, '[["1"],["2"]]')
    ...
    def testVisitsFromSearchShouldReturnZeroIfNoSearchKey(self):
        self.fake_api_response(piwik, '[{"label":"Websites","sum_daily_nb_uniq_visitors":176,"nb_visits":184,"nb_actions":393,"max_actions":33,"sum_visit_length":42592,"bounce_count":129,"nb_visits_converted":0},{"label":"Direct Entry","sum_daily_nb_uniq_visitors":99,"nb_visits":138,"nb_actions":293,"max_actions":36,"sum_visit_length":22162,"bounce_count":107,"nb_visits_converted":0}]')
        visits_from_search = self.piwik.visits_from_search(1)
    ...
    def testVisitsFromParliamentSummed(self):
        self.fake_api_response(piwik, """{"2003-06-01":[{"label":"Parliament","nb_uniq_visitors":153,"nb_visits":440,"nb_actions":2589,"max_actions":151,"sum_visit_length":144615,"bounce_count":173,"nb_visits_converted":0,"url":"http:\/\/www.parliament.uk\/"},
    ...
    def testChildren(self):
        self.fake_api_response(piwik, self.fake_mp_data())
