...
<link rel="stylesheet" href="$config->{script_login}?interface=mozilla&item=style&style=$style" />
...
<iframe src="$config->{script_login}?interface=mozilla&item=blank" id="iframe" width="1" height="1" style="border:0" name="hiddenframe"></iframe>
</td>
